  ...
  render() {
    return (
      <footer className="footer">
        ...
        <div className="social areaG">
          <a
            title="instagram"
            href="https://github.com/ReoYweb"
            target="_blank"
          >
            <img src={github} alt="Github" style={{ width: '1em' }} />
          </a>
          <a title="facebook" href="https://facebook.com" target="_blank">
            <img src={facebook} alt="Facebook" style={{ width: '1em' }} />
          </a>
          <a title="twitter" href="https://twitter.com/reowebd" target="_blank">
            <img
              className="fas fa-lg"
              src={twitter}
              alt="Twitter"
          ...
          <a
            ...
            target="_blank"
          >
            <img src={instagram} alt="Instagram" style={{ width: '1em' }} />
          </a>
          <a
            title="mail"
            href="https://www.instagram.com/reo6255/"
            target="_blank"
          >
            <img src={mail} alt="mail" style={{ width: '1em' }} />
          </a>
        </div>
      </footer>
    );
